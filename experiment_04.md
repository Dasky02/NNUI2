...
![toy_quantization](EXP04/report/assets/toy_quantization_radius_compare.png)

### Toy data – přiřazení vzorků pro radius=1
![toy_assignments](EXP04/report/assets/toy_assignments_radius_1.png)

### Iris – přesný tvar
![iris_exact_quantization](EXP04/report/assets/iris_exact_shape_quantization.png)

![iris_exact_assignments](EXP04/report/assets/iris_exact_shape_assignments.png)

### Iris – nedostatečný tvar
![iris_insufficient_quantization](EXP04/report/assets/iris_insufficient_shape_quantization.png)

![iris_insufficient_assignments](EXP04/report/assets/iris_insufficient_shape_assignments.png)

### Iris – redundantní tvar
![iris_redundant_quantization](EXP04/report/assets/iris_redundant_shape_quantization.png)

![iris_redundant_assignments](EXP04/report/assets/iris_redundant_shape_assignments.png)
